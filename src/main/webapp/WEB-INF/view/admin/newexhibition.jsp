        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <form action="${pageContext.request.contextPath}/servlet/newexhibition" method="post" align="center">



                        <div class="form-group">
                            <label for="exhname"><fmt:message key="EXHIBITION_NAME"/> </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="cat"><fmt:message key="EXHIBITION_CAT"/></label>
