        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <form action="${pageContext.request.contextPath}/servlet/newhall" method="post" align="center">

                        <div class="form-group">
                            <label for="hallname"><fmt:message key="HALL_NAME"/> </label>
                            <input type="text" class="form-control" id="hallname" name="hallname">
                        </div>

                        <div class="form-group">
                            <label for="halladdress"><fmt:message key="HALL_ADRESS"/> </label>
